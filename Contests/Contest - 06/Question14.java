/*
    ...
    Input Format - Enter the number of rows N1 and number of columns N2
    Constraints - None
    Output Format - Display the total number of paths and print all the possible paths in a space separated manner
    Sample Input - 
        3
        3
    Sample Output - 
...
public class Question14 {
    ...
    private static void paths(int sourceRow, int sourceCol, int destRow, int destCol, String path){
        ...
        paths(sourceRow + 1, sourceCol + 1, destRow, destCol, path + "D");
    }
